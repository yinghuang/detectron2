...
# D:\code\detectron2_custom\detectron2\detectron2\data\build.py build_batch_data_loader
# True: 选取大batch中的ratio相似的样本组成小batch, 
# False: 正常
...
_C.MODEL.RETINANET.BBOX_REG_LOSS_TYPE = "smooth_l1" # add by hy
